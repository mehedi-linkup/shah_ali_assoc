...
<div class="row" id="renterPaymentReport">
	...
	new Vue({
		...
		methods: {
			...
			getReport() {
				...
				axios.post('/get_renter_ledger', data).then(res => {
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-xs-6" style="font-size:12px;">
								<strong>Renter Code: </strong> ${this.selectedRenter.Renter_Code}<br>
								<strong>Name: </strong> ${this.selectedRenter.Renter_Name}<br>
								<strong>Address: </strong> ${this.selectedRenter.Renter_Address}<br>
								<strong>Mobile: </strong> ${this.selectedRenter.Renter_Mobile}<br>
							</div>
