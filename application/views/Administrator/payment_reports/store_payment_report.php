...
<div class="row" id="storePaymentReport">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right"> Store </label>
			<div class="col-sm-2">
	...
	new Vue({
		...
		methods: {
			...
			getReport() {
				...
				axios.post('/get_store_ledger', data).then(res => {
			...
			async print() {
				let reportContent = `
					<div class="container">
						<h4 style="text-align:center">Store payment report</h4 style="text-align:center">
						<div class="row">
							<div class="col-xs-6" style="font-size:12px;">
								<strong>Store Code: </strong> ${this.selectedStore.Store_Code}<br>
								<strong>Name: </strong> ${this.selectedStore.Store_Name}<br>
								<strong>Address: </strong> ${this.selectedStore.Store_Address}<br>
								<strong>Mobile: </strong> ${this.selectedStore.Store_Mobile}<br>
							</div>
