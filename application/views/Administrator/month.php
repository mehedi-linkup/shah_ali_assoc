...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="month" id="month" name="month" placeholder="Month Name" value="" class="col-xs-10 col-sm-4" />
				<span id="msc"></span>
			</div>
		</div>
...
<script type="text/javascript">
	 function updatedata(e){
		...
		var monthName = monthFormatter.format(date);
		var outputDate = monthName + ' ' + year;

		var inputdata = 'month_id='+month_id+'&month='+outputDate;
		//alert(inputdata);
...
<script type="text/javascript">
    function Submitdata(){
        ...
        var succes = "";
        if(succes == ""){
            var inputdata = 'month='+outputDate;
            //alert(inputdata);
