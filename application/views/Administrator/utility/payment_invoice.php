...
<div id="salesInvoiceReport" class="row">
  <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
    <div class="form-group" style="margin-top:10px;">
      ...
      <div class="col-sm-3">
        <v-select v-bind:options="invoices" label="invoice" v-model="selectedInvoice" v-on:input="viewInvoice" placeholder="Select Invoice"></v-select>
      </div>
    </div>
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <payment-invoice v-bind:payment_id="selectedInvoice.id" v-if="showInvoice"></payment-invoice>
  </div>
</div>
...
<script>
  ...
  new Vue({
    ...
    methods: {
      getSales() {
        axios.get("/get_store_payments").then(res => {
