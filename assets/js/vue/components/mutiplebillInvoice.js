    ...
    template: `
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>মিটার নংঃ </strong> {{ convertToBanglaNumber(row?.meter_no) }}<br>
                        <strong>নামঃ </strong> {{ row?.Store_Name }}<br>
                        <strong>দোকান নংঃ </strong> {{ convertToBanglaNumber(row?.Store_No) }}<br>
                        <strong>মাসঃ </strong> {{ bill.month_name }}<br>
                        <strong>তারিখঃ </strong> {{ startDate }} হইতে {{ endDate }} পর্যন্ত <br>
                    </div>
                    <div class="col-xs-5 text-right">
                        <strong>বিল নংঃ </strong> {{ convertToBanglaNumber(row.invoice) }}<br>
                        <strong>বিল তৈরির তারিখঃ </strong> {{ dateFormat(row?.process_date) }}<br>
                        <strong>বিল প্রদানের তারিখঃ </strong> ______________<br>
                        <strong>বিচ্ছিন্ন করণের তারিখঃ </strong> {{ addMonthsToDate(row?.process_date, 2) }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr>
                                    <td>১</td>
                                    <td>বিদ্যুৎ বিল</td>
                                    <td>{{ convertToBanglaNumber(row?.current_unit) }}</td>
                                    <td>{{ convertToBanglaNumber(row?.electricity_unit) }}</td>
                                    <td>{{ convertToBanglaNumber(utilityRate?.Electricity_Rate) }}</td>
                                    <td>{{ convertToBanglaNumber(row?.electricity_bill) }}</td>
                                </tr>
                                <tr>
                                    <td>২</td>
                                    <td>জেনারেটর</td>
                                    <td></td>
                                    <td>{{ convertToBanglaNumber(row?.generator_unit) }}</td>
                                    <td>{{ convertToBanglaNumber(utilityRate?.Generator_Rate) }}</td>
                                    <td>{{ convertToBanglaNumber(row?.generator_bill) }}</td>
                                </tr>
                                <tr>
                                    <td>৩</td>
                                    <td>সার্ভিস চার্জ</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ convertToBanglaNumber(row?.bill) }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ convertToBanglaNumber(parseFloat( +row?.previous_due + +row?.bill + +row?.late_fee).toFixed(2) ) }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
